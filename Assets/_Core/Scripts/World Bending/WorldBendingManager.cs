...
// This script enables the World Bending effect shader to display (and only when in Play mode) on GameObjects in the scene.
// Simply attach this script to some GameObject (like a Manager) in your scene and ensure that all of the GameObjects that
//you want this effect applied to have a variant of the World Bending Master material applied to their renderer
[ExecuteAlways]
public class WorldBendingManager : MonoBehaviour
{
  ...
  [SerializeField]
  [Range(0.005f, 0.1f)]
  private float bendingAmount = 0.01f;
